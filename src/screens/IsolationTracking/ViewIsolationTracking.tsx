...
import {
  getIsolationRecord,
  deleteIsolationRecord,
} from '../../api/isolationRecords';

const ViewIsolationTracking = () => {
  ...
  const loadRecord = async () => {
    ...
    setLoading(true);
    try {
      const data = await getIsolationRecord(recordId);
      setRecord(data);
    } catch (err: any) {
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              await deleteIsolationRecord(recordId);
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text size={13}>{record.isolation_type || '-'}</Text>
          </View>
          ...
          <View style={styles.detailRow}>
            ...
            <Text size={13}>{record.start_date || '-'}</Text>
          </View>
          ...
          <View style={styles.detailRow}>
            ...
            <Text size={13}>{record.end_date || '-'}</Text>
          </View>
        ...
        <View style={styles.actionContainer}>
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate('AddIsolationTracking', { editData: record })
            }
          >
            <Text bold color="#fff">
              Edit
...
export default ViewIsolationTracking;
